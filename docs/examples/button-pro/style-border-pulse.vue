...
<template>
  <div class="demo-button-pro">
    ...
    <div class="section-title">脉冲按钮 - 呼吸灯效果</div>
    <div class="button-row">
    ...
    <div class="section-title">脉冲按钮 - 圆形和图标</div>
    <div class="button-row">
      <el-button-pro
        type="primary"
        circle
        class="el-button-pro--pulse"
        :icon="Search"
      />
      <el-button-pro
        type="success"
...
import { Check, Delete, Message, Search, Star } from '@element-plus/icons-vue'
</script>
